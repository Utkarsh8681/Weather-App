...
<a href="https://github.com/Utkarsh8681"><img alt="License" src="https://img.shields.io/static/v1?label=GitHub&message=Utkarsh&color=C51162"/></a><br>
Weather is an Android app for Weather with Jetpack Compose. It uses [weatherAPI]([https://openweathermap.org/api](https://www.weatherapi.com/)). It is single screen app which displays weather data for a city.
...
## 📱 Screenshots
 <img src="https://github.com/user-attachments/assets/f01f9400-265b-41a5-a95d-90da323c238d" alt="" width="200" style= "margin-right: 50"/>
